...
import { close, menu, my_logo } from '../assets';
  ...
  return (
    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <img src={my_logo} alt="logo" className='w-36 h-11 object-contain' />
        <p className='text-white text-[18px] font-bold cursor-pointer flex'>Truong &nbsp;<span className='sm:block hidden'>| Frontend Developer</span></p>
        </Link>
